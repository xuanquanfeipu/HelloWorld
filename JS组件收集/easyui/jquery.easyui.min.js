...
(function($) {
	...
	$.fn.pagination.defaults = {
		...
		displayMsg: "第 {from} 到 {to} 条，共 {total} 条记录",
		nav: {
			first: {
			...
			return {
				...
				resize: function(_6c6, _6c7) {
					if (isA(_6c6, name)) {
						...
						$(_6c6)._outerWidth(_6c7)._outerHeight(32);
					}
				}
			};
		};
	...
	var _6c8 = $.extend({}, _6ba(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
		...
		validatebox: {
			...
			resize: function(_6df, _6e0) {
				$(_6df)._outerWidth(_6e0)._outerHeight(32);
			}
		}
	});
	$.fn.datagrid.methods = {
	...
	$.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
		...
		buttons: [{
			...
			handler: function(_986) {
				...
				$(_986).datebox('setValue', $.fn.datebox.defaults.formatter(new Date()));
				_975(_986);
			}
		}, {
			text: function(_987) {
