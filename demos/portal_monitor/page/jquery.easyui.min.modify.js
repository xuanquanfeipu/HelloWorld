...
if(_a8=="first"){
bb.first=_a9("first");
bb.first[0].className += " firstStyle";
}else{
if(_a8=="prev"){
bb.prev=_a9("prev");
bb.prev[0].className += " prevStyle";
}else{
if(_a8=="next"){
bb.next=_a9("next");
bb.next[0].className += " nextStyle";
}else{
if(_a8=="last"){
bb.last=_a9("last");
bb.last[0].className += " lastStyle";
}else{
if(_a8=="manual"){
/*$("<span style=\"padding-left:6px;\"></span>").html(_a4.beforePageText).appendTo(tr).wrap("<td></td>");*/
$("<span></span>").html(_a4.beforePageText).appendTo(tr).wrap("<td></td>");
...
bb.after=$("<span class=\"pagesStyle\"></span>").appendTo(tr).wrap("<td></td>");
}else{
if(_a8=="refresh"){
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["sep","first","prev","manual","next","last","sep","list"],onSelectPage:function(_c7,_c8){
...
if($elementClass.indexOf('tree-expanded') != -1 || $elementClass.indexOf('tree-collapsed') != -1)
    return;
...
var myLine = icon.prev();
if(myLine.hasClass("tree-checkbox"))
    myLine = myLine.prev();
myLine.addClass("tree-join");
...
hit.parent().find('.tree-folder').addClass("tree-folder-open");
...
if(hit.prev().length){
if(hit.prev().attr('class').indexOf('tree-checkbox')>=0){
hit.prev().remove();
$("<span class=\"tree-checkbox tree-checkbox0\"></span>").insertBefore(_15a);
}else
hit.prev().remove();
}
}
...
if(_2a8.fn){_2a8.fn();return false;}
_2a3();
if(_2a8.onClose){
...
var cls=opts.icon?"messager-icon messager-"+opts.icon:"messager-icon messager-info";
...
$.fn.menu.defaults={zIndex:110000,left:0,top:0,alignTo:null,align:"left",minWidth:85,itemHeight:28,duration:100,hideOnUnhover:true,inline:false,fit:false,noline:false,onShow:function(){
},onHide:function(){
...
_5e5.find("input[type=checkbox]").parent().unbind(".datagrid").bind("click.datagrid",function(e){
if(opts.singleSelect&&opts.selectOnCheck){
return false;
}
//if($(this).is(":checked")){
if($(this).css("background").indexOf('icon_checkbox.png') == -1){
_67b(_5e2);
}else{
_681(_5e2);
}
...
if(tt.hasClass("datagrid-cell-check")){
if(opts.singleSelect&&opts.selectOnCheck){
tt._propAttr("checked",!tt.is(":checked"));
_5f8(_5f6,_5f7);
}else{
//if(tt.is(":checked")){
if(tt.css("background").indexOf('icon_checkbox.png') == -1){
...
tr.find("div.datagrid-cell-check").css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_checkbox.png) no-repeat center");
tr=opts.finder.getTr(_683,"","checked",2);
if(tr.length==opts.finder.getRows(_683).length){
var dc=_686.dc;
var haha=dc.header1.add(dc.header2);
haha.find("input[type=checkbox]")._propAttr("checked",true);
haha.find("input[type=checkbox]").parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_checkbox.png) no-repeat center");
}
if(opts.idField){
...
tr.find("div.datagrid-cell-check").css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_check.png) no-repeat center");
var dc=_68a.dc;
var _68b=dc.header1.add(dc.header2);
_68b.find("input[type=checkbox]")._propAttr("checked",false);
_68b.find("input[type=checkbox]").parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_check.png) no-repeat center");
if(opts.idField){
...
hck.parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_checkbox.png) no-repeat center");
bck.parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_checkbox.png) no-repeat center");
if(opts.idField){
for(var i=0;i<rows.length;i++){
...
hck.parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_check.png) no-repeat center");
bck.parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_check.png) no-repeat center");
if(opts.idField){
for(var i=0;i<rows.length;i++){
...
if(_773){
tr.find("div.datagrid-cell-check input[type=checkbox]")._propAttr("checked",true);
tr.find("div.datagrid-cell-check input[type=checkbox]").parent().css("background" ,"url(/zxbeas-web/res/beas-datamodel/images/icon_checkbox.png) no-repeat center");
}
};
_770.call(this,true);
...
cc.push("class=\"datagrid-cell myTreeStyle "+col.cellClass);
}
cc.push("\">");
if(col.checkbox){
if(row.checked){
...
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{panelWidth:292,panelHeight:390,panelAlign:'right',sharedCalendar:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
{text:function(_a0f){
	return $(_a0f).datebox("options").cleanText;
	},handler:function(_a0g){
		$(_a0g).combo('setValue','').combo('setText','');
		$(this).closest("div.combo-panel").panel("close");
	}
}
...
$.fn.datetimebox.defaults=$.extend({},$.fn.datebox.defaults,{panelHeight:410,spinnerWidth:"98%",showSeconds:true,timeSeparator:":",keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
return $(_a2g).datetimebox("options").cleanText;
},handler:function(_a2h){
$(_a2h).combo('setValue','').combo('setText','');
$(this).closest("div.combo-panel").panel("close");
//}},{text:function(_a2e){
...
/**
 * 扩展基本方法，获取到用户的真实输入，并鉴定其索引值是否有效，undefined，则用户的输入是空值
 * @param {} target value
 * @return 索引值
 *
 */
function getComBoBoxRowIndex(target, value){
...
/**
 * 扩展基本方法，获取到用户的真实输入，并判断该真实输入是否有效
 * @param {} jq
 * @return {}
 */
$.extend($.fn.combobox.methods, {
    doEnter:function(t){
        ...
        var vv = [];
        $.map(t.combobox('getValues'), function(v){
            if (getComBoBoxRowIndex(t[0], v) >= 0){
                vv.push(v);
            }
        });
        t.combobox('setValues', vv);
